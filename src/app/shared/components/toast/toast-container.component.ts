...
@Component({
      ...
      @for (toast of notifications.toasts(); track toast.id) {
        <div class="toast" [class]="'toast-' + toast.type" (click)="notifications.dismiss(toast.id)">
          ...
          <div class="toast-content">
            ...
            <button class="toast-close" (click)="notifications.dismiss(toast.id); $event.stopPropagation()">×</button>
          </div>
        </div>
      }
    </div>
  ...
  styles: [`
    ...
    .toast-success .toast-accent { background: var(--profit); }
    .toast-error .toast-accent { background: var(--loss); }
