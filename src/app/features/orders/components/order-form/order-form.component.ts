...
@Component({
          ...
          <form [formGroup]="form" (ngSubmit)="onSubmit()" class="dialog-body">
            <div class="form-grid">
              ...
              <div class="form-field">
                ...
                @if (form.get('orderType')?.touched && form.get('orderType')?.errors?.['required']) {
              ...
              <div class="form-field">
                ...
                @if (form.get('executionType')?.touched && form.get('executionType')?.errors?.['required']) {
              ...
              <div class="form-field">
                ...
                @if (form.get('strategyId')?.touched && form.get('strategyId')?.errors?.['required']) {
              ...
              <div class="form-field">
                ...
                @if (form.get('tradingAccountId')?.touched && form.get('tradingAccountId')?.errors?.['required']) {
              ...
              <div class="form-field form-field-full">
                ...
                <textarea class="form-textarea" formControlName="notes" rows="3" placeholder="Optional notes..."></textarea>
              </div>
            ...
            <div class="dialog-actions">
              <button type="button" class="btn btn-secondary" (click)="onCancel()" [disabled]="loading()">Cancel</button>
  ...
  styles: [`
    ...
    .btn-secondary:hover:not(:disabled) { background: var(--bg-tertiary); opacity: 0.8; }
