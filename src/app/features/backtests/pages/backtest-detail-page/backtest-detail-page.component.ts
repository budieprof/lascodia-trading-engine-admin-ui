  ...
  template: `
    <div class="page">
      <app-page-header
        ...
        subtitle="Historical simulation results"
      >
      ...
      @if (backtest(); as bt) {
        ...
        <div class="metrics-row">
          <app-metric-card
            label="Win Rate"
            [value]="resultMetrics().winRate"
            format="percent"
            dotColor="#34C759"
          />
          <app-metric-card
            label="Profit Factor"
            [value]="resultMetrics().profitFactor"
            format="number"
            dotColor="#0071E3"
          />
          <app-metric-card
            label="Sharpe Ratio"
            [value]="resultMetrics().sharpe"
            format="number"
            dotColor="#AF52DE"
          />
          <app-metric-card
            label="Max Drawdown"
            [value]="resultMetrics().maxDrawdown"
            format="percent"
            dotColor="#FF3B30"
          />
          <app-metric-card
            label="Total Trades"
            [value]="resultMetrics().totalTrades"
            format="number"
            dotColor="#5AC8FA"
          />
          <app-metric-card
            label="Avg Trade P&L"
            [value]="resultMetrics().avgPnL"
            format="currency"
            [colorByValue]="true"
          />
        </div>
        ...
        <div class="charts-grid">
          <app-chart-card
            title="Equity Curve"
            subtitle="Cumulative P&L over backtest period"
            [options]="equityCurveOptions"
            height="320px"
          />
          <app-chart-card
            title="Drawdown"
            subtitle="Peak-to-trough drawdown"
        ...
        <div class="charts-grid">
          <app-chart-card
            ...
            subtitle="Distribution of individual trade results"
            [options]="pnlDistOptions"
            height="280px"
          />
          <app-chart-card
            title="Monthly Returns"
            subtitle="P&L by month"
        ...
        <div class="charts-grid">
          ...
          <app-chart-card
            ...
            subtitle="Average performance per day"
            [options]="dowOptions"
            height="250px"
          />
        </div>
        ...
        <div class="info-card">
          <div class="info-grid">
            ...
            <div class="info-item">
              <span class="info-label">Symbol</span><span class="info-value">{{ bt.symbol }}</span>
            </div>
            <div class="info-item">
            ...
            <div class="info-item">
              ...
              ><span class="info-value">\${{ bt.initialBalance.toLocaleString() }}</span>
            </div>
            <div class="info-item">
...
export class BacktestDetailPageComponent implements OnInit {
  ...
  // Sample chart data
  private days = Array.from({ length: 180 }, (_, i) => {
  ...
  equityCurveOptions: EChartsOption = {
    ...
    xAxis: {
      type: 'category',
      data: this.days,
      axisLabel: { fontSize: 10, color: '#6E6E73', interval: 29 },
    },
    yAxis: {
      type: 'value',
  ...
  drawdownOptions: EChartsOption = {
    ...
    series: [
      {
        type: 'line',
        data: this.days.map(() => Math.random() * 8),
        smooth: true,
        symbol: 'none',
  ...
  pnlDistOptions: EChartsOption = {
    ...
    xAxis: {
      type: 'category',
      data: ['-200', '-150', '-100', '-50', '0', '50', '100', '150', '200', '250'],
    ...
    series: [
      {
        type: 'bar',
        data: [5, 12, 25, 38, 15, 42, 35, 22, 10, 3].map((v, i) => ({
          value: v,
          itemStyle: { color: i < 4 ? '#FF3B30' : '#34C759', borderRadius: [4, 4, 0, 0] },
        })),
      },
    ],
  };
  ...
  monthlyOptions: EChartsOption = {
    ...
    series: [
      {
        type: 'bar',
        data: [320, -150, 480, 210, -80, 560, 390, -220, 410, 280, 150, -90].map((v) => ({
          value: v,
    ...
    series: [
      {
        ...
        data: Array.from({ length: 20 }, () => {
          const v = Math.floor(Math.random() * 8) - 3;
          return { value: v, itemStyle: { color: v >= 0 ? '#34C759' : '#FF3B30' } };
        }),
      },
    ],
  };
