      ...
      @if (activeTab() === 'prices') {
        ...
        <div class="charts-row">
          <app-chart-card
            ...
            subtitle="Current spreads across all pairs"
      ...
      @if (activeTab() === 'analytics') {
        <div class="charts-grid">
          ...
          <app-chart-card
            ...
            subtitle="Spread over time per pair"
        ...
        <div class="charts-grid">
          ...
          <app-chart-card
            ...
            subtitle="Price correlation between pairs"
        ...
        <div class="charts-grid">
          <app-chart-card
            ...
            subtitle="Average spread by hour of day"
...
export class MarketDataPageComponent implements OnInit, OnDestroy {
  ...
  correlationOptions: EChartsOption = {
    ...
    xAxis: {
      ...
      axisLabel: { fontSize: 10, color: '#6E6E73', rotate: 30 },
    },
    yAxis: {
      type: 'category',
      data: ['EUR/USD', 'GBP/USD', 'USD/JPY', 'AUD/USD'],
  ...
  loadPrices() {
    const requests = this.watchedSymbols.map((symbol) =>
      this.marketDataService.getLivePrice(symbol).pipe(catchError(() => of(null))),
    );
